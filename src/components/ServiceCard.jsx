...
function ServiceCard({service , index}) {
  ...
  return ( 
       ...
       onMouseEnter={()=> setVisible(true)} onMouseLeave={()=> setVisible(fals)} ref={divRef} onMouseMove={handleMouseMove}>

           <div className={`pointer-events-none blur-2xl rounded-full bg-gradient-to-r from-blur-500 via-indigo-500 to-purple-500
