...
function ContactUs() {
  return (
      ...
      <div className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
         <Title title="Reach out to us" description= "from strategy to execution, we craft digital solutions that move your buiness forward"/>
         ...
         <form className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
            ...
            <div className='sm:col-span-2'>
               ...
               <textarea  className='w-full p-3 text-sm outline-none rounded-lg 
               border border-gray-300 dark:border-gray-600' rows={8} placeholder='Enter your message'/>
            </div>
